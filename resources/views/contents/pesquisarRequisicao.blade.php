...
@section('pesquisarRequisicao-body')
    ...
    @if (session('success'))
    <div id="error-box" class="fixed inset-0 flex items-center justify-center z-50">
        <div class="bg-green-600 border-l-4 border-green-800 text-white px-6 py-4 rounded-lg shadow-lg relative mb-4 w-3/4 sm:w-1/2 md:w-1/3">
            <strong class="font-bold text-xl">Avaliação Enviada com Sucesso!</strong>
            <br>
